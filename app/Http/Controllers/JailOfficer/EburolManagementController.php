...
class EburolManagementController extends Controller
{
    ...
    public function index(): Response
    {
        $eburols = Eburol::with('user')
            ...
            ->map(function ($eburol) {
                return [
                    ...
                    'death_certificate_path' => $eburol->death_certificate_path ? route('jail-officer.eburols.document.death-certificate', $eburol) : null,
                    'relationship_proof_path' => $eburol->relationship_proof_path ? route('jail-officer.eburols.document.relationship-proof', $eburol) : null,
        ...
        return Inertia::render('JailOfficer/EburolManagement', [
            'eburols' => $eburols,
            'stats' => $stats,
    ...
    public function approve(Request $request, Eburol $eburol): RedirectResponse
    {
        ...
        return redirect()->route('jail-officer.eburols.index')
