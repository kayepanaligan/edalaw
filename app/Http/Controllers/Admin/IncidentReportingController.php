...
{
    /**
     * Display all incidents with search and filters.
     */
    public function index(Request $request): Response
    {
        ...
        $incidents = $query->orderByDesc('created_at')
            ...
            ->through(fn (Incident $incident) => [
                ...
                'monitor_name' => $incident->monitoringSession?->monitor
                    ? trim("{$incident->monitoringSession->monitor->first_name} {$incident->monitoringSession->monitor->last_name}")
                    : null,
        ...
        return Inertia::render('Admin/IncidentReporting', [
            'incidents' => $incidents,
            'filters' => [
                'search' => $request->search,
