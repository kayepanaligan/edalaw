...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Notifications', href: '/jail-officer/notifications' },
];
...
export default function Notifications({ notifications, unread_count: unreadCount }: Props) {
    ...
    const handleMarkAsRead = (notificationId: number) => {
        ...
        router.post(`/jail-officer/notifications/${notificationId}/read`, {}, {
            preserveScroll: true,
    ...
    const handleMarkAllAsRead = () => {
        ...
        router.post('/jail-officer/notifications/read-all', {}, {
            preserveScroll: true,
