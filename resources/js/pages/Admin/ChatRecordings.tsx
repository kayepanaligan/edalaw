...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Chat Recordings', href: '/admin/chat-recordings' },
];
                ...
                <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                        <DropdownMenuItem asChild>
                            <Link href={`/admin/chat-recordings/session/${row.original.id}`}>
                                <Eye className="mr-2 h-4 w-4" />
                            </Link>
                        </DropdownMenuItem>
                        <DropdownMenuItem asChild>
                            <Link href={`/admin/chat-recordings/session/${row.original.id}/export`}>
