...
export default function IncidentReporting({ incidents, filters: initialFilters }: Props) {
    ...
    const columns: ColumnDef<IncidentRow>[] = useMemo(
        () => [
            ...
            },
            {
                ...
                cell: ({ row }) => (
                    <div className="text-sm">{row.original.monitor_name ?? '—'}</div>
                ),
            },
        ],
        []
    ...
    const handleFilter = () => {
        router.get('/admin/incident-reporting', {
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-6">
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-muted-foreground">View and filter all incident reports</p>
                    </div>
                </div>
                    ...
                    <CardHeader>
                        <div className="flex flex-wrap items-end gap-4">
                            ...
                            <div className="flex flex-col gap-1">
                                <Label htmlFor="ir-date_from" className="text-xs">From Date</Label>
                                <Input
                                    id="ir-date_from"
                                    type="date"
                                    value={dateFrom}
                            ...
                            <div className="flex flex-col gap-1">
                                <Label htmlFor="ir-date_to" className="text-xs">To Date</Label>
                                <Input
                                    id="ir-date_to"
                                    type="date"
                                    value={dateTo}
