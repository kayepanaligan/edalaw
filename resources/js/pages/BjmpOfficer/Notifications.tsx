...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Notifications', href: '/bjmp-officer/notifications' },
];
...
export default function Notifications({ notifications, unread_count: unreadCount }: Props) {
    ...
    const handleMarkAsRead = (notificationId: number) => {
        ...
        router.post(`/bjmp-officer/notifications/${notificationId}/read`, {}, {
            preserveScroll: true,
    ...
    const handleMarkAllAsRead = () => {
        ...
        router.post('/bjmp-officer/notifications/read-all', {}, {
            preserveScroll: true,
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-6">
                <div>
                    ...
                    <p className="text-muted-foreground">Visit schedules, e-burol applications, appeals, and system alerts</p>
                </div>
                {notifications.length === 0 ? (
                    <Card>
                        <CardContent className="flex flex-col items-center justify-center py-12">
                            ...
                            <p className="text-sm text-muted-foreground mt-2">You will see updates here when applications or appeals are processed.</p>
                        </CardContent>
                    </Card>
                ) : (
                    <Card>
