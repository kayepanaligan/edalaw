...
export default function InmateManagement({ inmates, cells, filters }: Props) {
    ...
    const handleCreateSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        createForm.post('/bjmp-officer/inmates', {
            onSuccess: () => {
    ...
    const handleEditSubmit = (e: React.FormEvent) => {
        ...
        editForm.put(`/bjmp-officer/inmates/${selectedInmate.id}`, {
            onSuccess: () => {
    ...
    const handleDeleteSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (!selectedInmate) return;
        deleteForm.delete(`/bjmp-officer/inmates/${selectedInmate.id}`, {
            onSuccess: () => {
    ...
    const handleTransferSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (!selectedInmate) return;
        transferForm.post(`/bjmp-officer/inmates/${selectedInmate.id}/transfer`, {
            onSuccess: () => {
