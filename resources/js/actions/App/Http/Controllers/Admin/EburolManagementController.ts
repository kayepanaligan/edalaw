...
/**
* @see \App\Http\Controllers\Admin\EburolManagementController::deathCertificate
 * @see app/Http/Controllers/Admin/EburolManagementController.php:316
 * @route '/admin/eburols/{eburol}/document/death-certificate'
 */
...
deathCertificate.definition = {
    methods: ["get","head"],
    url: '/admin/eburols/{eburol}/document/death-certificate',
} satisfies RouteDefinition<["get","head"]>
...
/**
* @see \App\Http\Controllers\Admin\EburolManagementController::relationshipProof
 * @see app/Http/Controllers/Admin/EburolManagementController.php:330
 * @route '/admin/eburols/{eburol}/document/relationship-proof'
 */
...
relationshipProof.definition = {
    methods: ["get","head"],
    url: '/admin/eburols/{eburol}/document/relationship-proof',
} satisfies RouteDefinition<["get","head"]>
...
const EburolManagementController = { index, store, update, destroy, approve, reject, updateStatus, deathCertificate, relationshipProof }
