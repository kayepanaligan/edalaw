 ...
 * @see app/Http/Controllers/Admin/UserManagementController.php:182
 * @route '/admin/users'
 */
 ...
 * @see app/Http/Controllers/Admin/UserManagementController.php:246
 ...
 * @see app/Http/Controllers/Admin/UserManagementController.php:330
 * @route '/admin/users/{user}'
 */
 ...
 * @see app/Http/Controllers/Admin/UserManagementController.php:96
...
/**
* @see \App\Http\Controllers\Admin\UserManagementController::updateStatus
 * @see app/Http/Controllers/Admin/UserManagementController.php:132
 * @route '/admin/users/{user}/update-status'
 */
export const updateStatus = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
...
updateStatus.definition = {
    methods: ["post"],
    url: '/admin/users/{user}/update-status',
} satisfies RouteDefinition<["post"]>
 ...
 * @route '/admin/users/{user}/update-status'
 */
updateStatus.post = (args: { user: number | { id: number } } | [user: number | { id: number } ] | number | { id: number }, options?: RouteQueryOptions): RouteDefinition<'post'> => ({
    url: updateStatus.url(args, options),
    method: 'post',
})
const UserManagementController = { index, store, update, destroy, approve, reject, updateStatus }
